...
public class HPVTestDialog1 extends javax.swing.JDialog
{
    LabRec labRec;
    HPVRec hpv;
    int labNumber;
	...
	public HPVTestDialog1(HPVRec hpv, int labNumber)
	{
		this();
	...
	public HPVTestDialog1(LabRec labRec)
	{
		this();
        this.log = new LogFile(
            DbConnection.getLogPath(),
	...
	{
		(new HPVTestDialog1()).setVisible(true);
	}
	...
	class SymWindow extends java.awt.event.WindowAdapter
	{
		public void windowClosing(java.awt.event.WindowEvent event)
		{
			...
			if (object == HPVTestDialog1.this)
				HPVTestDialog1_windowClosing(event);
		}
		...
		public void windowOpened(java.awt.event.WindowEvent event)
		{
			Object object = event.getSource();
			if (object == HPVTestDialog1.this)
				HPVTestDialog1_windowOpened(event);
		}
	}

	void HPVTestDialog1_windowOpened(java.awt.event.WindowEvent event)
	{
		HPVTestSent.setEnabled(true);
		HPVTestSent.requestFocus();
	}

	void HPVTestDialog1_windowClosing(java.awt.event.WindowEvent event)
	{
		closingActions();
	}
	...
	class SymKey extends java.awt.event.KeyAdapter
	{
		public void keyPressed(java.awt.event.KeyEvent event)
		{
			...
			else if (object == HPVTestDialog1.this)
				HPVTestDialog1_keyPressed(event);
		}
	...
	void HPVTestDialog1_keyPressed(java.awt.event.KeyEvent event)
	{
