...
public class PayerFileDialog extends PcsDialog
{
    Login dbLogin;
	...
	public PayerFileDialog(PcsFrame parent)
	{
	...
	protected JRootPane setupKeyPressMap() {
		...
		rp.getActionMap().put("F9", new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				PayerFileDialog.this.dispose();
			}
		});
		rp.getActionMap().put("F10", new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				 PayerFileDialog.this.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));
	                getPending();
	                PayerFileDialog.this.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
			}
		});
		rp.getActionMap().put("F12", new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				PayerFileDialog.this.finalActions();
			}
		});
		return rp;
	}
