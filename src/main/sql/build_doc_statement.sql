...
as                                                                                                                                                                                  
   ...
   cursor lab_list is                                                                                                                                                               
      ...
      select SUBSTR(TO_CHAR(lq.lab_number),5,10),RTRIM(p.lname)||', '||RTRIM(p.f                                                                                                    
         TO_CHAR(lr.datestamp,'MMDD'),li.procedure_code,pc.description,                                                                                                             
                                                                                                                                                                                    
         TO_CHAR(li.item_amount,'9999.99'),RTRIM(bc.choice_code),                                                                                                                   
                                                                                                                                                                                    
         TO_CHAR(lq.date_collected,'MMDD'),lq.lab_number,li.item_amount                                                                                                             
                                                                                                                                                                                    
      from pcs.lab_requisitions lq, pcs.patients p, pcs.lab_billing_items li,                                                                                                       
                                                                                                                                                                                    
         pcs.lab_billings lb, pcs.practice_statement_labs ps, pcs.lab_results lr                                                                                                    
      ...
      where lq.patient=p.patient and lq.lab_number=lb.lab_number and                                                                                                                
         ...
         lr.lab_number=ps.lab_number and lb.lab_number=li.lab_number and                                                                                                            
                                                                                                                                                                                    
         lb.rebilling=li.rebilling and li.procedure_code=pc.procedure_code and                                                                                                      
                                                                                                                                                                                    
         lb.billing_choice=bc.billing_choice and                                                                                                                                    
                                                                                                                                                                                    
         lq.practice=S_practice and ps.year_month=200402                                                                                                                            
...
begin                                                                                                                                                                               
   ...
   select count(*) into is_rebuild from pcs.practice_statement_labs                                                                                                                 
   ...
   S_file_name:=RTRIM(practice_id||substr(cbuf,5,2)||substr(cbuf,1,1)||substr(cb                                                                                                    
   dir_name:=RTRIM('vol1:');                                                                                                                                                        
   ...
   select count(*) into rcnt from pcs.payments                                                                                                                                      
      ...
      where TO_NUMBER(TO_CHAR(payment_date,'YYYYMM'))=S_month and account_id=S_p                                                                                                    
   ...
   and lq.billing_choice=S_billing_choice and                                                                                                                                       
      ...
      TO_NUMBER(TO_CHAR(lr.datestamp,'YYYYMM'))=S_month and lq.practice=S_practi                                                                                                    
   ...
   */                                                                                                                                                                               
   ...
   select TO_CHAR(NVL(sum(payment_amount),0),'99990.99'), NVL(sum(payment_amount                                                                                                    

   into S_ttl_plus_adjusts, ttl_p_adjust from pcs.payments                                                                                                                          
                                                                                                                                                                                    
   where TO_NUMBER(TO_CHAR(payment_date,'YYYYMM'))=S_month and account_id=S_prac                                                                                                    
   ...
   */                                                                                                                                                                               
   ...
   loop                                                                                                                                                                             
      ...
      if (last_lab<>S_lab and is_rebuild<1) then                                                                                                                                    
                                                                                                                                                                                    
         insert into pcs.practice_statement_labs (statement_id,lab_number)                                                                                                          
                                                                                                                                                                                    
         values (stmt_id,L_num);                                                                                                                                                    
      ...
      */                                                                                                                                                                            
      ...
      if (line_num>60) then                                                                                                                                                         
         ...
         cbuf:=margin||'CLIENT NUMBER: '||practice_id||'     PERIOD ENDING: '||S                                                                                                    
         curr_line:=cbuf;                                                                                                                                                           
   ...
   select prior_balance,total_charges,total_payments,total_plus,total_minus,tota                                                                                                    
   ...
   if (line_num>50) then                                                                                                                                                            
      ...
      cbuf:=margin||'CLIENT NUMBER: '||practice_id||'     PERIOD ENDING: '||S_pe                                                                                                    
      curr_line:=cbuf;                                                                                                                                                              
...
exception                                                                                                                                                                           
   ...
   when OTHERS then                                                                                                                                                                 
      ...
      values (P_error_code,P_error_message,P_proc_name,P_code_area,SysDate,UID,S                                                                                                    
      commit;                                                                                                                                                                       
