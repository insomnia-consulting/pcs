create or replace procedure     build_eom_summary_file
(
   S_month in number
)
as
...
begin
   ...
   heading2:=margin||'SUMMARY OF BILLING TYPES REPORT';
   heading3:=margin||'MONTH ENDING: '||S_period;
