...
as                                                                                                                                                                                  
   ...
   cursor lab_list is                                                                                                                                                               
      ...
      where L.lab_number=R.lab_number and L.patient=P.patient and                                                                                                                   
         ...
         TO_NUMBER(TO_CHAR(R.datestamp,'YYYYMM'))=S_month;                                                                                                                          
      ...
      loop                                                                                                                                                                          
         ...
         if (L_path='Y') then                                                                                                                                                       
            ...
            loop                                                                                                                                                                    
               ...
               select count(*) into rcnt from pcs.beth_std_xref                                                                                                                     
               where bethesda_code=path_fields.bethesda_code;                                                                                                                       
               if (rcnt>0) then                                                                                                                                                     
                  select priority into L_priority                                                                                                                                   
                  from pcs.beth_std_xref                                                                                                                                            

                  where bethesda_code=path_fields.bethesda_code;                                                                                                                    
                  if (L_priority>highest_priority) then                                                                                                                             
                     highest_priority:=L_priority;                                                                                                                                  
                     select quantitative,qualitative                                                                                                                                
                     into L_quan_results,L_description                                                                                                                              
                     from pcs.beth_std_xref                                                                                                                                         
                     where bethesda_code=path_fields.bethesda_code;                                                                                                                 
                  end if;                                                                                                                                                           
               end if;                                                                                                                                                              
            ...
            loop                                                                                                                                                                    
               ...
               select count(*) into rcnt from pcs.beth_std_xref                                                                                                                     
               where bethesda_code=qc_fields.bethesda_code;                                                                                                                         
               if (rcnt>0) then                                                                                                                                                     
                  select priority into L_priority                                                                                                                                   
                  from pcs.beth_std_xref                                                                                                                                            
                  where bethesda_code=qc_fields.bethesda_code;                                                                                                                      
            ...
            loop                                                                                                                                                                    
               ...
               select count(*) into rcnt from pcs.beth_std_xref                                                                                                                     
               where bethesda_code=result_fields.bethesda_code;                                                                                                                     
               if (rcnt>0) then                                                                                                                                                     
                  select priority into L_priority                                                                                                                                   
                  from pcs.beth_std_xref                                                                                                                                            
                  where bethesda_code=result_fields.bethesda_code;                                                                                                                  
         ...
         if (L_description is NULL) then L_description:='999';                                                                                                                      
         end if;                                                                                                                                                                    
         ...
         where lab_number=L_lab_number;                                                                                                                                             
         if (rcnt>0) then                                                                                                                                                           
            select test_sent, test_results into L_HPV_sent, L_HPV_results                                                                                                           
            from pcs.hpv_requests                                                                                                                                                   
            where lab_number=L_lab_number;                                                                                                                                          
            if (L_HPV_results IS NULL and L_HPV_sent='Q') then                                                                                                                      
               L_HPV:='3';                                                                                                                                                          
            elsif (L_HPV_results='-') then                                                                                                                                          
               L_HPV:='2';                                                                                                                                                          
            elsif (L_HPV_results='+') then                                                                                                                                          
               L_HPV:='1';                                                                                                                                                          
