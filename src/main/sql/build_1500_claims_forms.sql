procedure build_1500_claim_forms                                                
 (                                                                              
 C_directory in char,                                                           
 C_file in char,                                                                
...
';                                                                              
 ...
 or C_billing_route='DUP' or C_billing_route='ENV') and carrier_idnum<>1048) the
n                                                                               
 ...
 /* This block of code removed 04/18/13; it prevented the patient's DOB 
  * from * being printed on the form. Code commented out for now pending testing * 
  * of a batch of paper claims. The goto statement label must also be removed. if 
  * (C_choice_code='DPA' and carrier_state='OH') then goto skip_ln5; end if; 
  */                
 ...
 /* PA DPA wants DOS listed only once; Alamama wants it done once
  * Personal Choice BS wants it listed twiece.
  */
 if (carrier_idnum=1048) then                                                   
 cbuf1:=lab_completed||'       ';                                               
